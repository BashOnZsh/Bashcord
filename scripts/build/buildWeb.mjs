...
async function buildExtension(target, files) {
    const entries = {
        "dist/Bashcord.js": await readFile("dist/browser/extension.js"),
        "dist/Bashcord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Bashcord.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Bashcord.user.js", cssRuntime);
});
